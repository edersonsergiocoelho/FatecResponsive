...
<html lang="en">
    <head>
        <title>Fatec Americana - Alterar Notícia</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
        ...
        <h1 style="text-align: center">Alterar Notícia</h1>
        ...
        <form id="formNoticia" name="formNoticia" action="NoticiaController" method="post">
            <div class="form-group">
                ...
                <textarea class="form-control" id="descricaoNoticia" name="descricaoNoticia" required>
                    <c:out value="${noticia.descricaoNoticia}"></c:out>
                </textarea>
            </div>
            <div class="form-group">
